...
def plot_metrics_and_loss(experiment_names, metrics_info, loss_info, metrics_subplot_layout, loss_subplot_layout,
                          metrics_figure_size=(15, 10), loss_figure_size=(15, 10), base_directory='runs/plot'):
    # Plot metrics
...
metrics_filename, loss_filename = plot_metrics_and_loss(
    experiment_names=['YOLOv5s', 'YOLOv6s', 'YOLOv7-tiny', 'YOLOv8n', 'YOLOv8s', 'YOLOv8s-p2', 'YOLOv8s-SPM'],
